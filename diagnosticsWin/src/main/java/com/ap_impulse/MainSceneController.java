...
import com.ap_impulse.bd.Database;
...
public class MainSceneController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {//"initialize()" to initialize any controls
	       ...
	       URL url = getClass().getResource("/static/function.svg");
	       ...
	       dataBase.setOnAction(e -> { 	   								
	    	   if (Database.isOK()) {  
					...
					try {
					    ...
					    Scene scene = new Scene(rootDatabase); // Scene ���������� ���������� ����� (stage)  
					        newStage.setScene(scene); // ��������� ���������� � ����
					        newStage.setTitle("Database"); 
					        newStage.show(); // � ������� ������ show ������ Stage ������������ �� ������ ����������.  
